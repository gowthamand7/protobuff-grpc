...
const (
	...
	CommentService_ListComments_FullMethodName  = "/CommentService/ListComments"
...
type CommentServiceClient interface {
	...
	DeleteComment(ctx context.Context, in *GetCommentRequest, opts ...grpc.CallOption) (*Comment, error)
}
...
func (c *commentServiceClient) DeleteComment(ctx context.Context, in *GetCommentRequest, opts ...grpc.CallOption) (*Comment, error) {
	out := new(Comment)
...
type CommentServiceServer interface {
	...
	DeleteComment(context.Context, *GetCommentRequest) (*Comment, error)
...
func (UnimplementedCommentServiceServer) DeleteComment(context.Context, *GetCommentRequest) (*Comment, error) {
...
var CommentService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "ytservice/comment.proto",
}
